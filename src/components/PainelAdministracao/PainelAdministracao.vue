<template>
    ...
    <div class="mb-4">
        ...
        <div class="flex align-items-center justify-content-between">
            <div>
                ...
                <p class="">Gerencie os temas de votação</p>
            </div>
            <Button
                label="Novo Tema"
                icon="pi pi-plus"
    ...
    <div v-else>
        ...
        >
            <Column field="foto" header="Foto" sortable :class="{ 'whitespace-nowrap': true }">
                <template #body="{ data }">
                        <Image
                            :src="data.foto"
                            :alt="data.nome"
            ...
            <Column field="dataCriacao" header="Criado em" sortable>
                <template #body="{ data }">
